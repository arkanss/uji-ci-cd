        ...
        <div
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                    @forelse ($orders as $order)
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors {{ in_array($order->id, $selectedOrders) ? 'bg-blue-50 dark:bg-blue-900/20' : '' }}"
                            ...
                            <td class="px-4 py-3 text-sm">
                                <flux:badge :color="$order->status?->color() ?? 'zinc'" size="sm" variant="subtle">
                            ...
                            <td class="px-4 py-3 text-sm">
                                @if ($order->outlet)
                                    <flux:badge icon="building-storefront" color="yellow" variant="subtle"
                                        size="sm">
                                        {{ $order->outlet->name }}
                                    </flux:badge>
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-4 py-12 text-center text-zinc-500">Belum ada request pesanan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
                    ...
                    <div
                        ...
                        <div class="pr-2">
                            ...
                            <p class="text-sm font-bold text-zinc-800 dark:text-zinc-200">
                                {{ $selectedOrder->requester->name ?? 'System' }}
                            </p>
                        </div>
                    </div>
                </div>
