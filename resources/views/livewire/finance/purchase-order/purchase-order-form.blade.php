    ...
    <form wire:submit.prevent="save" class="space-y-6">
            ...
            <x-ui.card title="Shipping Information">
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <flux:field>
                        ...
                        <flux:input type="text" wire:model="reference_number" placeholder="Vendor quote reference" />
                    </flux:field>
                </div>
            </x-ui.card>
        </div>
        ...
        <x-ui.card>
            <div class="flex items-center justify-between mb-4">
                ...
                <flux:button variant="primary" icon="plus" wire:click.prevent="addItem" size="sm">
                    Add Item
                </flux:button>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 border border-zinc-200 dark:border-zinc-700 rounded">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <flux:button variant="ghost" size="sm" wire:click.prevent="removeItem({{ $index }})"
                            class="text-red-600">
                            Remove
                        </flux:button>
                    </div>
                    ...
                    <div class="grid md:grid-cols-4 gap-3">
                        ...
                        <flux:field>
                            ...
                            <flux:error name="items.{{ $index }}.requested_stock" />
                        </flux:field>
                        ...
                        <flux:field>
                            ...
                            <flux:input type="text" wire:model="items.{{ $index }}.tax_code" placeholder="e.g. VAT10" />
                        </flux:field>
                        ...
                        <div class="md:col-span-2">
                            <flux:field>
                                ...
                                <flux:input type="text" wire:model="items.{{ $index }}.item_description"
                        ...
                        <flux:field>
                            ...
                            <flux:input type="date" wire:model="items.{{ $index }}.requested_delivery_date" />
                        </flux:field>

                        <flux:field>
                            <flux:label>Bin Location</flux:label>
                            <flux:input type="text" wire:model="items.{{ $index }}.warehouse_bin_location"
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    <flux:field>
                        ...
                        <flux:input type="number" step="0.01" min="0" wire:model.blur="freight_charges" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Other Charges</flux:label>
                        <flux:input type="number" step="0.01" min="0" wire:model.blur="other_charges" />
                    </flux:field>
